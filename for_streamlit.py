...
tagging_prompt = ChatPromptTemplate.from_template("""คุณคือผู้ช่วยด้านการวิเคราะห์ความคิดเห็นของลูกค้าสำหรับโครงการ Social Listening ที่เกี่ยวข้องกับบริการรถไฟฟ้า BTS ในประเทศไทย งานของคุณคือการจัดประเภทข้อความตามเงื่อนไขต่อไปนี้
...
st.markdown("### 📌 หมวดหมู่ที่เป็นไปได้")
df = pd.DataFrame(CATEGORIES.items(), columns=["หมวดหมู่", "รายละเอียด"])
st.table(df)
